...
describe('Tests disableValidator()', function() {
  ...
  it('Lets a staking manager role disable a validator after they are added', async function() {
  ...
  it('Emits ValidatorDisabled when a (enabled) validator is disabled', async function() {
    await proofChain.connect(stakingManager).enableValidator(0);
